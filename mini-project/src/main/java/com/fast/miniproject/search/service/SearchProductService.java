...
public class SearchProductService {
    ...
    public Page<ProductDTO> searchProducts(String searchTarget, String searchKeyword, String sortTarget, String sortKeyword, Pageable pageable, UserDTO.LoginReqDTO loginReqDTO) {
